...
const GameBoard = (props,id) => {
  ...
  cells.map((cellSpace) => {
    console.log("cellSpace here line 69") 
   ...
   for (let patternArr of winningPatterns) { 
    ...
    console.log(`player: ${player} patternOne:  ${patternOne}  cellSpace.value ${cellSpace.value}  cellSpace.id ${cellSpace.id}`)  
      if(cellSpace.value === player && cellSpace.id === patternOne && cellSpace.id === pattern) {
          console.log("cellSpace here") 
          console.log(cellSpace) 
